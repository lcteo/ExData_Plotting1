...
plot(reqconsumption$Datetime, reqconsumption$Sub_metering_1, xlab = "", ylab = "Energy sub metering", type = "l", ylim = ylmt, col = "black")
par(new = TRUE)
plot(reqconsumption$Datetime, reqconsumption$Sub_metering_2, xlab = "", axes = FALSE, ylab = "", type = "l", ylim = ylmt, col = "red")
par(new = TRUE)
plot(reqconsumption$Datetime, reqconsumption$Sub_metering_3, xlab = "", axes = FALSE, ylab = "", type = "l", ylim = ylmt, col = "blue")
legend("topright",
